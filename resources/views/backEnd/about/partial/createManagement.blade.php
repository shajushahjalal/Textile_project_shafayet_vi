    ...
    <div class="modal fade" role="dialog" keyboard="false" data-backdrop="static" >
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title">{{!isset($data->id)?'Add Management List':'Update Management List'}}</h5>            
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {!! Form::open(['url'=>'about/management/create','id'=>'ajax-form','method'=>'post','files' => true]) !!}
