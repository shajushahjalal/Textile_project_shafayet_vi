<!-- Category Modal -->
<div class="modal fade" id="sub-catefory-modal" keyboard="false" data-backdrop="static" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
        ...
        {!! Form::Open(['url' => 'sub-category/create','id'=>'sub-catefory-form','class' =>'form-horizontal','method' => 'POST','files'=>true]) !!}
